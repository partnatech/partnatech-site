          ...
          <div className="flex min-h-[240px] flex-col justify-between space-y-8">
            <div className="space-y-4">
              <Image
                ...
                src={"/assets/images/portfolio-sample.png"}
                alt=""
                width="560"
                height="240"
              />
            ...
            <div>
              <Link href="">
                <div className="flex items-center justify-center">
                  <button className="w-full cursor-not-allowed rounded-md bg-primary px-4 py-3  font-semibold text-white shadow-sm hover:bg-teal-500">
                    Show Project
                  </button>
                </div>
              </Link>
